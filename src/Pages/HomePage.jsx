...
function HomePage() {
  ...
  useEffect(() => {
    setLoading(false)
    axios.get('https://nicbackend-production.up.railway.app/hello-world/')
      .then(response => {
  ...
  const handleUserInput=(e)=>{
    ...
    axios
    .get(`https://nicbackend-production.up.railway.app/recommend?user_tags=${user_tags}&age=${age}&social_category=${social_category}&gender=${gender}&domicile_of_tripura=${domicile_of_tripura}`)
    .then((response)=>{
      response.data=response.data.slice(1,-1);
